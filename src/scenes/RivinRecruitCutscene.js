...
export class RivinRecruitCutscene extends Phaser.Scene {
  ...
  create() {
    ...
    const lines = [
      { text: 'Rivin: "Captain Metz, is it? Word travels. The dead walk the eastern woods."', image: null },
      { text: 'Rivin: "I\'ve fought in three border wars. My axe is sharp, and I need the coin."', image: null },
      { text: 'Rivin: "Give me a cut of whatever we loot, and I\'ll hold the line beside you."', image: null },
      { text: '[ Rivin the Warrior has joined your party! ]', image: null },
    ];
