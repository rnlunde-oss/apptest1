...
export class OverworldScene extends Phaser.Scene {
  ...
  buildMap() {
    ...
    const spawn = this.loadedPos || this.playerSpawn || { x: 496, y: 6032 };
  ...
  checkEncounter(tx, ty) {
    ...
    const ZONE_MAP = {
      ...
      20: { zone: 'swamp', rate: ENCOUNTER_RATE_SWAMP },
