...
export const QUEST_DEFS = {
  ...
  act1_secure_bracken: {
    ...
    giver: 'auto',
    giverName: 'Captain Metz',
    description: 'Journey to Fort Bracken and search for survivors. Secure the fort by defeating the Skeletal Captain holding the gate.',
    objectives: [
      ...
      { id: 'defeat_skeletal_captain', type: 'defeat_enemy', target: 'skeletal_captain', description: 'Secure Fort Bracken', required: 1 },
    ],
