...
export function serializeGameState(registry, playerPos) {
  ...
  return {
    ...
    rivinRecruitPlayed: registry.get('rivinRecruitPlayed') || false,
    ...
    newsOfAtikeshCutscenePlayed: registry.get('newsOfAtikeshCutscenePlayed') || false,
    fromTheAshesDialoguePlayed: registry.get('fromTheAshesDialoguePlayed') || false,
    makarFarewellPlayed: registry.get('makarFarewellPlayed') || false,
    tertullianShieldPlayed: registry.get('tertullianShieldPlayed') || false,
    cravenForestApproachPlayed: registry.get('cravenForestApproachPlayed') || false,
    dhanRendezvousPlayed: registry.get('dhanRendezvousPlayed') || false,
    cravenForestEntryCutscenePlayed: registry.get('cravenForestEntryCutscenePlayed') || false,
    fortRitkerCutscenePlayed: registry.get('fortRitkerCutscenePlayed') || false,
